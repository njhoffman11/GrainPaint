...
def run(rank, size, model, sample_corrupt, mask, iteration):
    ...
    output = ddm_sampler.generate_sample_resample(model, local_sample, T=250, mask=local_mask, seed=None, iteration=iteration)
...
ddm_load_path = "model_checkpoints/ddm32_small_iso.ckpt"
